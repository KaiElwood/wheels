...
Prisma access is isolated to server-side modules and server pages, and I kept the DTOs the existing snake-case style rather than updating to camelcase. Maybe I'll change this later.
